...
export default async (req, res, next) => {
    try {
      ...
      const getLivreur = await Livreur.findOne({ where: { liv_id: req.livreur.liv_id } })
      ...
      if(!fs.existsSync(__dirname + '/../../../assets/uploadedFilesLivreur/' + req.livreur.liv_id)) {
        fs.mkdirSync(__dirname + '/../../../assets/uploadedFilesLivreur/' + req.livreur.liv_id)
      }

      let uploadPathLicence = __dirname + '/../../../assets/uploadedFilesLivreur/' + req.livreur.liv_id + '/' + renameLicence
      let uploadathExtrait = __dirname + '/../../../assets/uploadedFilesLivreur/' + req.livreur.liv_id + '/' +  renameExtrait
      let uploadPathPermis = __dirname + '/../../../assets/uploadedFilesLivreur/' + req.livreur.liv_id + '/' + renamePermis
